...
|------|-----------|------------------|
| **Lead Developer & Game Logic** | Adiel Sedigo | Core rhythm game mechanics, judgment system, combo scoring, note timing algorithms, game loop implementation |
| **UI/UX Designer & Frontend Developer** | Ryan Cañano | Website portal design, CSS styling, responsive layouts, leaderboard integration, Firebase authentication |
